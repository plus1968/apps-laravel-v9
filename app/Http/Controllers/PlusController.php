...
class PlusController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($password =='nannormal'){
            $title  = 'หน้าหลัก || รวมลิงค์';
            return view('plus.index',compact('title'));
        }else{
    ...
    public function myhouse() 
    {
        ...
        $title  = 'ขายบ้าน !! | ทาวน์เฮาส์ 2 ชั้น';
        return view('playground.myhouse',compact('title'));
